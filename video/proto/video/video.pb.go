...
type Video struct {
	...
	Author        *info2.User `protobuf:"bytes,2,opt,name=author,proto3" json:"author,omitempty"`                                     // 视频作者信息
	...
	CreateTime    int64       `protobuf:"varint,9,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`          // 视频的创建时间[用户的上传时间]
}
...
func (x *Video) GetAuthor() *info2.User {
	if x != nil {
		return x.Author
	}
	return nil
...
var file_video_video_proto_rawDesc = []byte{
	...
	0x2f, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x97, 0x02, 0x0a, 0x05,
	...
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x55, 0x73, 0x65,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x1e, 0x5a, 0x1c, 0x74, 0x69, 0x6e, 0x79, 0x74, 0x69, 0x6b,
...
var file_video_video_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_video_video_proto_goTypes = []interface{}{
	(*Video)(nil),      // 0: video.Video
	(*info2.User)(nil), // 1: info.User
}
var file_video_video_proto_depIdxs = []int32{
	1, // 0: video.Video.author:type_name -> info.User
