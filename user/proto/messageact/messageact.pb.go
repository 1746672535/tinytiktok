...
func (x *MessageActionRequest) Reset() {
	*x = MessageActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_user_messageact_proto_msgTypes[0]
...
func (*MessageActionRequest) Descriptor() ([]byte, []int) {
	return file_user_messageact_proto_rawDescGZIP(), []int{0}
}
...
func (x *MessageActionResponse) Reset() {
	*x = MessageActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_user_messageact_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MessageActionResponse) Descriptor() ([]byte, []int) {
	return file_user_messageact_proto_rawDescGZIP(), []int{1}
}
...
var File_user_messageact_proto protoreflect.FileDescriptor

var file_user_messageact_proto_rawDesc = []byte{
	0x0a, 0x15, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x61, 0x63,
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x61, 0x63, 0x74, 0x22, 0x85, 0x01, 0x0a, 0x14, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x41,
	...
	0x73, 0x4d, 0x73, 0x67, 0x42, 0x22, 0x5a, 0x20, 0x74, 0x69, 0x6e, 0x79, 0x74, 0x69, 0x6b, 0x74,
	0x6f, 0x6b, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x61, 0x63, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_user_messageact_proto_rawDescOnce sync.Once
	file_user_messageact_proto_rawDescData = file_user_messageact_proto_rawDesc
)

func file_user_messageact_proto_rawDescGZIP() []byte {
	file_user_messageact_proto_rawDescOnce.Do(func() {
		file_user_messageact_proto_rawDescData = protoimpl.X.CompressGZIP(file_user_messageact_proto_rawDescData)
	})
	return file_user_messageact_proto_rawDescData
}

var file_user_messageact_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_user_messageact_proto_goTypes = []interface{}{
	(*MessageActionRequest)(nil),  // 0: messageact.MessageActionRequest
	(*MessageActionResponse)(nil), // 1: messageact.MessageActionResponse
}
var file_user_messageact_proto_depIdxs = []int32{
...
func init() { file_user_messageact_proto_init() }
func file_user_messageact_proto_init() {
	if File_user_messageact_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_user_messageact_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_messageact_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_user_messageact_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_user_messageact_proto_goTypes,
		DependencyIndexes: file_user_messageact_proto_depIdxs,
		MessageInfos:      file_user_messageact_proto_msgTypes,
	}.Build()
	File_user_messageact_proto = out.File
	file_user_messageact_proto_rawDesc = nil
	file_user_messageact_proto_goTypes = nil
	file_user_messageact_proto_depIdxs = nil
}
