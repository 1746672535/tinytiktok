...
func (x *MessageChatRequest) Reset() {
	*x = MessageChatRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_user_messagechat_proto_msgTypes[0]
...
func (*MessageChatRequest) Descriptor() ([]byte, []int) {
	return file_user_messagechat_proto_rawDescGZIP(), []int{0}
}
...
func (x *MessageChatResponse) Reset() {
	*x = MessageChatResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_user_messagechat_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MessageChatResponse) Descriptor() ([]byte, []int) {
	return file_user_messagechat_proto_rawDescGZIP(), []int{1}
}
...
func (x *Message) Reset() {
	*x = Message{}
	if protoimpl.UnsafeEnabled {
		mi := &file_user_messagechat_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_user_messagechat_proto_rawDescGZIP(), []int{2}
}
...
var File_user_messagechat_proto protoreflect.FileDescriptor

var file_user_messagechat_proto_rawDesc = []byte{
	0x0a, 0x16, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x63, 0x68,
	0x61, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x63, 0x68, 0x61, 0x74, 0x22, 0x6a, 0x0a, 0x12, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x65, 0x22, 0xa2, 0x01, 0x0a, 0x13, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x68, 0x61,
	...
	0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x88, 0x01, 0x01, 0x12, 0x37,
	0x0a, 0x0c, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x63, 0x68,
	0x61, 0x74, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x0b, 0x6d, 0x65, 0x73, 0x73,
	...
	0x6d, 0x65, 0x42, 0x23, 0x5a, 0x21, 0x74, 0x69, 0x6e, 0x79, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b,
	0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x63, 0x68, 0x61, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_user_messagechat_proto_rawDescOnce sync.Once
	file_user_messagechat_proto_rawDescData = file_user_messagechat_proto_rawDesc
)

func file_user_messagechat_proto_rawDescGZIP() []byte {
	file_user_messagechat_proto_rawDescOnce.Do(func() {
		file_user_messagechat_proto_rawDescData = protoimpl.X.CompressGZIP(file_user_messagechat_proto_rawDescData)
	})
	return file_user_messagechat_proto_rawDescData
}

var file_user_messagechat_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_user_messagechat_proto_goTypes = []interface{}{
...
var file_user_messagechat_proto_depIdxs = []int32{
...
func init() { file_user_messagechat_proto_init() }
func file_user_messagechat_proto_init() {
	if File_user_messagechat_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_user_messagechat_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_messagechat_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_messagechat_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_user_messagechat_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_user_messagechat_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_user_messagechat_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_user_messagechat_proto_goTypes,
		DependencyIndexes: file_user_messagechat_proto_depIdxs,
		MessageInfos:      file_user_messagechat_proto_msgTypes,
	}.Build()
	File_user_messagechat_proto = out.File
	file_user_messagechat_proto_rawDesc = nil
	file_user_messagechat_proto_goTypes = nil
	file_user_messagechat_proto_depIdxs = nil
}
