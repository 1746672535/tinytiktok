...
func init() {
	...
	// 读取配置
	address := dbConfig.ReadString("Address")
	port := dbConfig.ReadInt("Port")
	username := dbConfig.ReadString("Username")
	password := dbConfig.ReadString("Password")
	dbName := dbConfig.ReadString("Dbname")
